...
sovereignty in an age of spam, propaganda, data breaches, leaks, and
censorship. Users can easily manage their relationships, ensuring
private, programmable, reliable, and seamless communication.
...
** Properties
*** Authenticated
With Telepathyk, you always know with maximum confidence, that content
is really from who it says it's from. Since no one can impersonate
anyone else, a lot of current internet problems go away completely or
are greatly diminished: phishing, propaganda, deep fakes. It can go
even further with a small tweak from hardware makers to keep audio and
video trustworthy even after AI makes faking audio and video trivial:
digitally sign the recording inside the hardware that captured
it. Camera manufacturers like Sony could theoretically still make fake
videos, but third parties couldn't.
...
much content that they could not serve it from their own device. All
that remains is coordinating the communication, which is easily
modeled inside telepathyk. 
...
email, issue tracking, scheduling, payments, administration, etc.
