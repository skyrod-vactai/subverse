...
Telepathyk: A communication software designed to empower users by
...
communication sovereignty in an age of constant data breaches, privacy
...
With Telepathyk, users can control the content that influences their
thoughts, filtering out unwanted bots, shills, or spammers. The
software enables the bypassing of censorship, allowing free and open
messaging to anyone interested in receiving them. Customizability is
at the core of Telepathyk, offering a user-friendly programming
interface and the ability to share customizations as easily as any
other content.
...
message was really written by who it claims to be from. Phishing
becomes impossible, no one can impersonate your friends, associates,
...
*** Trusted
Your attention is precious, and the internet is awash in bullshit.
It's a kind of parasite, sucking your attention and resources. Even if
you aren't swayed by it, you still waste time wading through it to
find legitimate quality content. By closing the door to anyone you
don't trust, you cut off the flow of garbage content, leaving you in
peace with just those who deserve your attention - friends, family,
people you admire.

There is no legitimate scenario where you want to see a message from
an unidentified or untrusted party. Anyone who wants to communicate
with you will need to be introduced first.
...
Both obscure the message, but telepathy also obscures who you
communicated with - in fact they don't know that you communicated
anything at all. Telepathy doesn't exist in the real world but it
exists online, if you choose to use it.
...
+ Programmable
+ Transience - some data is a liability and should not be kept
...
*** INPROGRESS Signing and verification
