...
diminished: phishing, propaganda, deep fakes. It can go even further
with a small tweak from hardware makers to keep audio and video
trustworthy even after AI makes faking audio and video trivial:
...
failure. If the hospital's central system goes down, patients can
still be treated, doctors can still view xrays and prescribe
medication and nurses can receive that information and administer
treatments. The administration's system can catch up when it comes
back online.
