...
#+begin_src kcats
  [[make-simple-script [[secret] unassign [first] sort wrap [sink verify] join emit bytes]]
   [delegated-script [[secret] unassign
                      [[sink ;; css cs pk
  ...
  ["bar" bytes key ;; child key
   ...
   [sign] shield ;; sign it
   float
   make-simple-script [hash] shield 

   "foo" bytes key swap [sign] shielddown ;; sig hash pk

   swap
   delegated-script

   ;; ps cssig cs msig m
   [hash] shield swap dump
   authenticate
  ] 
  let
...
#+RESULTS:
#+begin_src kcats
[#b64 "" #b64 "zS6d398nwCs2wQHdksZHzJ6ehyVk8ftPS7qNsDQ5q4M=" #b64 "ordodvDX8kNhFllnC++7Y5eELx9pF3hsuIH2+lkgmrqF2HuqJ/nEN0ru2mChKk1naYrBW2VA2gfmCCPvkdn9BQ==" #b64 "W1tbcHVibGljICNiNjQgInpLUmJRR3JZaHBsOE5OaHZOQnNoSVZPaHpJRStPdG1abytGUmJvTG9GNEU9Il0gW3R5cGUgZWxsaXB0aWMtY3VydmUta2V5XV0gc2luayB2ZXJpZnld" #b64 "wX8EhVgU6RLipJ77haemv9ISE3UDosCv/OUGYCKWPEiyRxCEMyAnzZGZ9hRI+MUmloTXbk/gx9h0KGWUxkGjDA==" #b64 "d2UgYXR0YWNrIGF0IGRhd24="]
...
[[[type elliptic-curve-key]
 ...
 [sink [[bytes hash]
        [shield dip]
        decorated float string read first [verify] dip dump [[]] branch]
  [drop drop sink verify] [clone] dipdown branch]
 [[]] recover]
#b64 "ordodvDX8kNhFllnC++7Y5eELx9pF3hsuIH2+lkgmrqF2HuqJ/nEN0ru2mChKk1naYrBW2VA2gfmCCPvkdn9BQ=="
#b64 "W1tbcHVibGljICNiNjQgInpLUmJRR3JZaHBsOE5OaHZOQnNoSVZPaHpJRStPdG1abytGUmJvTG9GNEU9Il0gW3R5cGUgZWxsaXB0aWMtY3VydmUta2V5XV0gc2luayB2ZXJpZnld"
